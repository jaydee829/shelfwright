...
def upgrade() -> None:
    ...
    op.create_table('narrator_styles',
    ...
    op.create_table('work_contributors',
    sa.Column('work_id', sa.UUID(), nullable=False),
    sa.Column('author_id', sa.UUID(), nullable=False),
    ...
    op.create_table('edition_narrators',
