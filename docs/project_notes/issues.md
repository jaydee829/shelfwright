...
- **Status**: Merged to `main` via squash (#86); CI green. Frontend-only — no deploy/migration needed (the new cloud renders client-side from the existing `/analysis` payload).
