...
### 2026-06-26 - GH #83: Word cloud improvements (packed/rotated/frequency-accentuated)
- **Status**: PR #86 CI-green, Gemini review addressed — awaiting operator squash-merge
